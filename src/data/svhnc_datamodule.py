"""SVHN-C DataModule with dynamic corruption generation."""
...
class SVHNCDataModule:
    """Data module for SVHN-C with Active Learning setup.

    Dynamically generates corruption on a subset of the pool data.

    Note: SVHN's .data attribute is [N, 3, H, W] (channels-first uint8).
    ...
    def _inject_corruption(self, pool_idx, seed):
        ...
        SVHN .data is [N, 3, H, W] uint8. imagecorruptions expects [H, W, 3],
