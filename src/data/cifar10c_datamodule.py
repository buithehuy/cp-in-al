"""CIFAR-10-C DataModule with dynamic corruption generation."""
...
class CIFAR10CDataModule:
    """Data module for CIFAR-10-C with Active Learning setup.
    ...
    def __init__(self, cfg):
        ...
        self.std = cfg.get('std', [0.2470, 0.2435, 0.2616])
